...
const {verify,getUsers,signin,login,sendOtp,changePassword,submitOtp,resetPassword,deleteUsers,deleteUser,updateUser} = require("../controllers/userController");
